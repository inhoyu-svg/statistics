...
> **💡 확실하지 않으면 y좌표를 0~7 범위로 보수적으로 설정하세요.**
...
**🎯 V자 찢김 모범 답안 (도수 모드 기본값, gridDivisions 5~7):**
```json
"cells": [
  "0-7:8-7",     // 차트 상단 전체를 덮는 시작점 (넓게)
  "1-6:7-6",     // 조금 좁아짐
  "2-5:6-5",     // 더 좁아짐
  "3-4:5-4",     // 데이터 소실 구간 근처
  "4-3"          // 찢김의 끝점 (뾰족하게)
]
```

**🎯 V자 찢김 모범 답안 (customYInterval: 1로 세밀하게, gridDivisions≈14):**
```json
"cells": [
  "0-13:8-13",   // 상단 전체
  "1-12:8-13",   // 조금 좁아짐
...
**패턴 예시 (도수 모드 기본값, gridDivisions≈7):**
```
y(그리드)
  7 |■■■■■■■■■□□  ← 상단에서 넓게 시작
  6 |□■■■■■■■□□□
...
**결과**: 차트 상단에서 V자 형태로 자연스럽게 찢어진 효과가 적용됩니다. (도수 모드 기본값 gridDivisions≈7 기준)
