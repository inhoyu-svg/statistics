...
**🎯 계단식 찢김 모범 답안 (customYInterval: 1, gridDivisions=14)**

**시나리오**: idx 2, 3을 가려야 하고, 도수가 각각 12, 10인 경우
- idx 1 (마진 왼쪽)의 도수: 4 → 마진은 y=5 이상만
- idx 4 (마진 오른쪽)의 도수: 8 → 마진은 y=9 이상만

```json
"cells": [
  "0-13:5-13",   // 상단 전체 (y=13이 최대)
  "1-12:4-12",   // idx 2 꼭대기 포함 ★도수 12 = y=12 반드시 포함★
  "1-11:4-11",   // idx 2 범위
  "2-10:3-10",   // idx 3 꼭대기 포함 ★도수 10 = y=10 반드시 포함★
  "2-9:3-9"      // 끝점 (idx 4 도수 8보다 위에서 끝남)
]
```

**패턴 예시 (위 시나리오 시각화):**
```
y(그리드)  idx: 0    1    2    3    4    5
  13 |         ■■  ■■  ■■  ■■  ■■  □□   ← 상단 전체
  12 |         ■■  ■■  ■■  ■■  ■■  □□   ← idx 2 꼭대기 (도수 12) ★반드시 포함★
  11 |         ■■  ■■  ■■  ■■  ■■  □□   ← idx 2 범위
  10 |         □□  ■■  ■■  ■■  □□  □□   ← idx 3 꼭대기 (도수 10) ★반드시 포함★
   9 |         □□  ■■  ■■  ■■  □□  □□   ← 끝점 (idx 4 도수 8보다 위)
   8 |         □□  □□  □□  □□  ██  □□   ← idx 4 실제 데이터 (안 건드림!)
   4 |         □□  ██  □□  □□  □□  □□   ← idx 1 실제 데이터 (안 건드림!)
```
> ⚠️ y=12, y=10을 찢지 않으면 막대 꼭대기가 보임!
