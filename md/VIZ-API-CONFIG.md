...
> - `customYInterval` 사용 시: `gridDivisions = ceil(maxY / customYInterval)`
>
> | customYInterval | 최대 도수 | Y축 눈금 | **유효 y좌표** |
> |:----------------|:----------|:---------|:---------------|
> | 없음 (기본) | 12 | 0~14 (자동) | **0~14** |
> | `1` | 12 | 0,1,2,...,14 | **0~14** |
> | `2` | 12 | 0,2,4,6,8,10,12,14 | **0~7** |
> | `5` | 12 | 0,5,10,15 | **0~3** |
>
> **⛔ gridDivisions 초과하는 y좌표는 무의미합니다!**
...
**🎯 V자 찢김 모범 답안 (customYInterval 없을 때, gridDivisions≈14):**
```json
"cells": [
  "0-13:8-13",   // 차트 상단 전체를 덮는 시작점 (넓게)
  "1-12:8-13",   // 조금 좁아짐
  "2-11:7-11",   // 더 좁아짐
  "3-10:6-10",   // 데이터 소실 구간 근처
  "2-9:5-9",     // 데이터 소실 구간 핵심
  "4-8"          // 찢김의 끝점 (뾰족하게)
]
```

**🎯 V자 찢김 모범 답안 (customYInterval: 2, gridDivisions≈7):**
```json
"cells": [
  "0-7:8-7",     // 상단 전체
  "1-6:7-6",     // 조금 좁아짐
...
**결과**: 차트 상단에서 V자 형태로 자연스럽게 찢어진 효과가 적용됩니다.
