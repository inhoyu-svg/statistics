...
> **⚠️ 자료/변량 표시는 `basic-table` + `showGrid: false` 사용** (아래 [자료(변량) 테이블 만들기](#자료변량-테이블-만들기) 참조)
...
**사용 상황**: 문제에 "자료" 또는 "변량"을 나타낸다고 명시된 경우

예) "다음은 민지네 반 남학생 30명의 멀리뛰기 기록을 조사하여 나타낸 **자료**이다."
