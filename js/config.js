...
const CONFIG = {
  ...
  TABLE_TYPE_INFO: {
    'frequency': {
      ...
      defaultData: '145, 152, 148, 160, 155, 162, 170, 158, 163, 168'
    },
    'category-matrix': {
      name: '카테고리 행렬',
    ...
    'stem-leaf': {
      ...
      placeholder: '남학생: 162, 175, 178, 184, 185, 188\n여학생: 160, 165, 170, 177, 180, 182',
      hint: '"라벨: 숫자들" 형식으로 두 그룹 입력 (예: 남학생, 여학생)',
      defaultData: '남학생: 162, 175, 178, 184, 185, 188\n여학생: 160, 165, 170, 177, 180, 182'
    }
  },
